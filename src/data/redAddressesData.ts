...
/**
 * ==============================================================================
 * DỮ LIỆU CHUẨN HÓA TOÀN DIỆN - DANH SÁCH ĐỊA CHỈ ĐỎ (DI TÍCH LỊCH SỬ)
 * Phường Bình Tiên, Thành phố Hồ Chí Minh
 * ==============================================================================
 */

export const RED_ADDRESSES_DATA: RedSite[] = [
  {
    id: 'red-site-1',
    ...
    imageUrl: '/pham-van-chi.png',
    galleryImages: ['/pham-van-chi.png'],
    image: '/pham-van-chi.png',
    images: ['/pham-van-chi.png'],
    toaDo: {
      lat: 10.74450,
      lng: 106.63480,
    },
  ...
  },
  {
    ...
    imageUrl: '/nha-truyen-thong-nguoi-hoa.png',
    galleryImages: ['/nha-truyen-thong-nguoi-hoa.png'],
    image: '/nha-truyen-thong-nguoi-hoa.png',
    images: ['/nha-truyen-thong-nguoi-hoa.png'],
    toaDo: {
      lat: 10.74830,
      lng: 106.65080,
    },
  ...
  },
  {
    ...
    galleryImages: ['/ham-in-hoa-van.png'],
    image: '/ham-in-hoa-van.png',
    images: ['/ham-in-hoa-van.png'],
    toaDo: {
      lat: 10.74980,
      lng: 106.65020,
    },
...
// Alias to maintain 100% backward compatibility
export const INITIAL_RED_SITES_DATA = RED_ADDRESSES_DATA;
